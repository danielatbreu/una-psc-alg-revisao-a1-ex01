...
class Exerc1Revisao {
  public static void main(String[] args) {
    ...
    Scanner scanner = new Scanner(System.in);
       ...
       System.out.println("\tOlá, iniciaremos o questionário para apresentar o relatório.");
        ...
        do {
        System.out.println("\nSeu cartão de vacina está em dia? Responda apenas com SIM ou NAO ?");
        ...
        break;
         ...
         contador++;
         System.out.println("\nDigito inválido! Responda apenas com SIM ou NAO.");
